// ======================================================================
// 3HC_Firmware_0_1.v generated from TopDesign.cysch
// 03/10/2020 at 18:19
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=538, CompareValue2=128, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=4096, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=X_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=X_PWM, CY_INSTANCE_SHORT_NAME=X_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=X_PWM, )
module PWM_v3_30_4 (
    reset,
    clock,
    tc,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=512, CompareValue2=128, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=4096, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Y_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Y_PWM, CY_INSTANCE_SHORT_NAME=Y_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Y_PWM, )
module PWM_v3_30_7 (
    reset,
    clock,
    tc,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=512, CompareValue2=128, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=4096, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Z_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Z_PWM, CY_INSTANCE_SHORT_NAME=Z_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Z_PWM, )
module PWM_v3_30_8 (
    reset,
    clock,
    tc,
...
module top ;
	...
	wire [0:0] tmpOE__QUAD_A_net;
	wire [0:0] tmpIO_0__QUAD_A_net;
	wire [0:0] tmpINTERRUPT_0__QUAD_A_net;
	electrical [0:0] tmpSIOVREF__QUAD_A_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		QUAD_A
		 (.oe(tmpOE__QUAD_A_net),
		  .y({1'b0}),
		  .fb({Net_1}),
		  .io({tmpIO_0__QUAD_A_net[0:0]}),
		  .siovref(tmpSIOVREF__QUAD_A_net),
		  .interrupt({tmpINTERRUPT_0__QUAD_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__QUAD_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__QUAD_B_net;
	wire [0:0] tmpIO_0__QUAD_B_net;
	wire [0:0] tmpINTERRUPT_0__QUAD_B_net;
	electrical [0:0] tmpSIOVREF__QUAD_B_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0330d153-403e-4201-a2d7-93879e2e94df"),
		  ...
		  .input_buffer_sel(2'b00))
		QUAD_B
		 (.oe(tmpOE__QUAD_B_net),
		  .y({1'b0}),
		  .fb({Net_2}),
		  .io({tmpIO_0__QUAD_B_net[0:0]}),
		  .siovref(tmpSIOVREF__QUAD_B_net),
		  .interrupt({tmpINTERRUPT_0__QUAD_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__QUAD_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_3 UpdateTimer_UI (
        ...
        .tc(Net_27),
        .clock(Net_10));
    defparam UpdateTimer_UI.CaptureCount = 2;
    defparam UpdateTimer_UI.CaptureCounterEnabled = 0;
    defparam UpdateTimer_UI.DeviceFamily = "PSoC5";
    defparam UpdateTimer_UI.InterruptOnCapture = 0;
    defparam UpdateTimer_UI.InterruptOnTC = 1;
    defparam UpdateTimer_UI.Resolution = 8;
    defparam UpdateTimer_UI.SiliconRevision = "0";
    ...
    PWM_v3_30_4 X_PWM (
        ...
        .ph1(Net_108),
        .ph2(Net_109));
    defparam X_PWM.Resolution = 16;

	wire [0:0] tmpOE__ENC_BTN_net;
	wire [0:0] tmpIO_0__ENC_BTN_net;
	wire [0:0] tmpINTERRUPT_0__ENC_BTN_net;
	electrical [0:0] tmpSIOVREF__ENC_BTN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c5cb5126-69ee-4392-ab2d-65b68ffc8289"),
		  ...
		  .input_buffer_sel(2'b00))
		ENC_BTN
		 (.oe(tmpOE__ENC_BTN_net),
		  .y({1'b0}),
		  .fb({Net_426}),
		  .io({tmpIO_0__ENC_BTN_net[0:0]}),
		  .siovref(tmpSIOVREF__ENC_BTN_net),
		  .interrupt({tmpINTERRUPT_0__ENC_BTN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENC_BTN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    I2C_v3_50_5 I2C_Module (
        .sda(Net_57),
        .scl(Net_58),
        .clock(1'b0),
        .reset(1'b0),
	...
	cy_isr_v1_0
		#(.int_type(2'b10))
		ADC_SAMPLECURRSENSOR
		 (.int_signal(Net_325));


    CyControlReg_v1_80 Output_Enable (
        .control_1(Net_118),
        .control_2(Net_119),
        .control_3(Net_120),
        .control_0(Net_348),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Output_Enable.Bit0Mode = 0;
    defparam Output_Enable.Bit1Mode = 0;
    defparam Output_Enable.Bit2Mode = 0;
    defparam Output_Enable.Bit3Mode = 0;
    defparam Output_Enable.Bit4Mode = 0;
    defparam Output_Enable.Bit5Mode = 0;
    defparam Output_Enable.Bit6Mode = 0;
    defparam Output_Enable.Bit7Mode = 0;
    defparam Output_Enable.BitValue = 0;
    defparam Output_Enable.BusDisplay = 0;
    defparam Output_Enable.ExtrReset = 0;
    defparam Output_Enable.NumOutputs = 1;

	wire [0:0] tmpOE__X_PWM_OUT_net;
	wire [0:0] tmpFB_0__X_PWM_OUT_net;
	wire [0:0] tmpIO_0__X_PWM_OUT_net;
	wire [0:0] tmpINTERRUPT_0__X_PWM_OUT_net;
	electrical [0:0] tmpSIOVREF__X_PWM_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		X_PWM_OUT
		 (.oe(tmpOE__X_PWM_OUT_net),
		  .y({Net_409}),
		  .fb({tmpFB_0__X_PWM_OUT_net[0:0]}),
		  .io({tmpIO_0__X_PWM_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__X_PWM_OUT_net),
		  .interrupt({tmpINTERRUPT_0__X_PWM_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X_PWM_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_131 = Net_348 & Net_115;
    ...
    PWM_v3_30_7 Y_PWM (
        ...
        .ph1(Net_276),
        .ph2(Net_277));
    defparam Y_PWM.Resolution = 16;

	wire [0:0] tmpOE__Y_PWM_OUT_net;
	wire [0:0] tmpFB_0__Y_PWM_OUT_net;
	wire [0:0] tmpIO_0__Y_PWM_OUT_net;
	wire [0:0] tmpINTERRUPT_0__Y_PWM_OUT_net;
	electrical [0:0] tmpSIOVREF__Y_PWM_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7ad568e7-81b6-44fa-8549-8ea3554d92ed"),
		  ...
		  .input_buffer_sel(2'b00))
		Y_PWM_OUT
		 (.oe(tmpOE__Y_PWM_OUT_net),
		  .y({Net_131}),
		  .fb({tmpFB_0__Y_PWM_OUT_net[0:0]}),
		  .io({tmpIO_0__Y_PWM_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__Y_PWM_OUT_net),
		  .interrupt({tmpINTERRUPT_0__Y_PWM_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y_PWM_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_199 = Net_348 & Net_198;
    ...
    PWM_v3_30_8 Z_PWM (
        ...
        .ph1(Net_302),
        .ph2(Net_303));
    defparam Z_PWM.Resolution = 16;

	wire [0:0] tmpOE__Z_PWM_OUT_net;
	wire [0:0] tmpFB_0__Z_PWM_OUT_net;
	wire [0:0] tmpIO_0__Z_PWM_OUT_net;
	wire [0:0] tmpINTERRUPT_0__Z_PWM_OUT_net;
	electrical [0:0] tmpSIOVREF__Z_PWM_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("35cc6518-760f-4917-994a-e88a0ef05cf2"),
		  ...
		  .input_buffer_sel(2'b00))
		Z_PWM_OUT
		 (.oe(tmpOE__Z_PWM_OUT_net),
		  .y({Net_199}),
		  .fb({tmpFB_0__Z_PWM_OUT_net[0:0]}),
		  .io({tmpIO_0__Z_PWM_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__Z_PWM_OUT_net),
		  .interrupt({tmpINTERRUPT_0__Z_PWM_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Z_PWM_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__X_DIR_OUT_net;
	wire [0:0] tmpFB_0__X_DIR_OUT_net;
	wire [0:0] tmpIO_0__X_DIR_OUT_net;
	wire [0:0] tmpINTERRUPT_0__X_DIR_OUT_net;
	electrical [0:0] tmpSIOVREF__X_DIR_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d251b638-14f3-487f-b32b-2660487b214a"),
		  ...
		  .input_buffer_sel(2'b00))
		X_DIR_OUT
		 (.oe(tmpOE__X_DIR_OUT_net),
		  .y({Net_314}),
		  .fb({tmpFB_0__X_DIR_OUT_net[0:0]}),
		  .io({tmpIO_0__X_DIR_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__X_DIR_OUT_net),
		  .interrupt({tmpINTERRUPT_0__X_DIR_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X_DIR_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 XYZ_Direction (
        .control_1(Net_311),
        .control_2(Net_312),
        .control_3(Net_313),
        .control_0(Net_314),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam XYZ_Direction.Bit0Mode = 0;
    defparam XYZ_Direction.Bit1Mode = 0;
    defparam XYZ_Direction.Bit2Mode = 0;
    defparam XYZ_Direction.Bit3Mode = 0;
    defparam XYZ_Direction.Bit4Mode = 0;
    defparam XYZ_Direction.Bit5Mode = 0;
    defparam XYZ_Direction.Bit6Mode = 0;
    defparam XYZ_Direction.Bit7Mode = 0;
    defparam XYZ_Direction.BitValue = 0;
    defparam XYZ_Direction.BusDisplay = 0;
    defparam XYZ_Direction.ExtrReset = 0;
    defparam XYZ_Direction.NumOutputs = 3;

	wire [0:0] tmpOE__Y_DIR_OUT_net;
	wire [0:0] tmpFB_0__Y_DIR_OUT_net;
	wire [0:0] tmpIO_0__Y_DIR_OUT_net;
	wire [0:0] tmpINTERRUPT_0__Y_DIR_OUT_net;
	electrical [0:0] tmpSIOVREF__Y_DIR_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8105b217-47fe-4563-9d4b-042e60516074"),
		  ...
		  .input_buffer_sel(2'b00))
		Y_DIR_OUT
		 (.oe(tmpOE__Y_DIR_OUT_net),
		  .y({Net_311}),
		  .fb({tmpFB_0__Y_DIR_OUT_net[0:0]}),
		  .io({tmpIO_0__Y_DIR_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__Y_DIR_OUT_net),
		  .interrupt({tmpINTERRUPT_0__Y_DIR_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y_DIR_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Z_DIR_OUT_net;
	wire [0:0] tmpFB_0__Z_DIR_OUT_net;
	wire [0:0] tmpIO_0__Z_DIR_OUT_net;
	wire [0:0] tmpINTERRUPT_0__Z_DIR_OUT_net;
	electrical [0:0] tmpSIOVREF__Z_DIR_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3313f5ef-acf1-41cd-a479-0ce67316d71b"),
		  ...
		  .input_buffer_sel(2'b00))
		Z_DIR_OUT
		 (.oe(tmpOE__Z_DIR_OUT_net),
		  .y({Net_312}),
		  .fb({tmpFB_0__Z_DIR_OUT_net[0:0]}),
		  .io({tmpIO_0__Z_DIR_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__Z_DIR_OUT_net),
		  .interrupt({tmpINTERRUPT_0__Z_DIR_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Z_DIR_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__X_CURR_SENSE_net;
	wire [0:0] tmpFB_0__X_CURR_SENSE_net;
	wire [0:0] tmpIO_0__X_CURR_SENSE_net;
	wire [0:0] tmpINTERRUPT_0__X_CURR_SENSE_net;
	electrical [0:0] tmpSIOVREF__X_CURR_SENSE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		X_CURR_SENSE
		 (.oe(tmpOE__X_CURR_SENSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__X_CURR_SENSE_net[0:0]}),
		  .analog({Net_336}),
		  .io({tmpIO_0__X_CURR_SENSE_net[0:0]}),
		  .siovref(tmpSIOVREF__X_CURR_SENSE_net),
		  .interrupt({tmpINTERRUPT_0__X_CURR_SENSE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X_CURR_SENSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Y_CURR_SENSE_net;
	wire [0:0] tmpFB_0__Y_CURR_SENSE_net;
	wire [0:0] tmpIO_0__Y_CURR_SENSE_net;
	wire [0:0] tmpINTERRUPT_0__Y_CURR_SENSE_net;
	electrical [0:0] tmpSIOVREF__Y_CURR_SENSE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("19e5ab5d-a267-4fba-8157-c0490f786235"),
		  ...
		  .input_buffer_sel(2'b00))
		Y_CURR_SENSE
		 (.oe(tmpOE__Y_CURR_SENSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Y_CURR_SENSE_net[0:0]}),
		  .analog({Net_337}),
		  .io({tmpIO_0__Y_CURR_SENSE_net[0:0]}),
		  .siovref(tmpSIOVREF__Y_CURR_SENSE_net),
		  .interrupt({tmpINTERRUPT_0__Y_CURR_SENSE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y_CURR_SENSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Z_CURR_SENSE_net;
	wire [0:0] tmpFB_0__Z_CURR_SENSE_net;
	wire [0:0] tmpIO_0__Z_CURR_SENSE_net;
	wire [0:0] tmpINTERRUPT_0__Z_CURR_SENSE_net;
	electrical [0:0] tmpSIOVREF__Z_CURR_SENSE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1972ccad-48ce-413b-a2eb-2b152ca19991"),
		  ...
		  .input_buffer_sel(2'b00))
		Z_CURR_SENSE
		 (.oe(tmpOE__Z_CURR_SENSE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Z_CURR_SENSE_net[0:0]}),
		  .analog({Net_338}),
		  .io({tmpIO_0__Z_CURR_SENSE_net[0:0]}),
		  .siovref(tmpSIOVREF__Z_CURR_SENSE_net),
		  .interrupt({tmpINTERRUPT_0__Z_CURR_SENSE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Z_CURR_SENSE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LCD_R_net;
	wire [0:0] tmpFB_0__LCD_R_net;
	wire [0:0] tmpIO_0__LCD_R_net;
	wire [0:0] tmpINTERRUPT_0__LCD_R_net;
	electrical [0:0] tmpSIOVREF__LCD_R_net;
	...
	cy_psoc3_pins_v1_10
		...
		LCD_R
		 (.oe(tmpOE__LCD_R_net),
		  .y({Net_385}),
		  .fb({tmpFB_0__LCD_R_net[0:0]}),
		  .io({tmpIO_0__LCD_R_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_R_net),
		  .interrupt({tmpINTERRUPT_0__LCD_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 LCD_Backlight (
        .control_1(Net_382),
        .control_2(Net_383),
        .control_3(Net_384),
        .control_0(Net_385),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LCD_Backlight.Bit0Mode = 0;
    defparam LCD_Backlight.Bit1Mode = 0;
    defparam LCD_Backlight.Bit2Mode = 0;
    defparam LCD_Backlight.Bit3Mode = 0;
    defparam LCD_Backlight.Bit4Mode = 0;
    defparam LCD_Backlight.Bit5Mode = 0;
    defparam LCD_Backlight.Bit6Mode = 0;
    defparam LCD_Backlight.Bit7Mode = 0;
    defparam LCD_Backlight.BitValue = 0;
    defparam LCD_Backlight.BusDisplay = 0;
    defparam LCD_Backlight.ExtrReset = 0;
    defparam LCD_Backlight.NumOutputs = 3;

	wire [0:0] tmpOE__LCD_G_net;
	wire [0:0] tmpFB_0__LCD_G_net;
	wire [0:0] tmpIO_0__LCD_G_net;
	wire [0:0] tmpINTERRUPT_0__LCD_G_net;
	electrical [0:0] tmpSIOVREF__LCD_G_net;
	...
	cy_psoc3_pins_v1_10
		...
		LCD_G
		 (.oe(tmpOE__LCD_G_net),
		  .y({Net_382}),
		  .fb({tmpFB_0__LCD_G_net[0:0]}),
		  .io({tmpIO_0__LCD_G_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_G_net),
		  .interrupt({tmpINTERRUPT_0__LCD_G_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD_G_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LCD_B_net;
	wire [0:0] tmpFB_0__LCD_B_net;
	wire [0:0] tmpIO_0__LCD_B_net;
	wire [0:0] tmpINTERRUPT_0__LCD_B_net;
	electrical [0:0] tmpSIOVREF__LCD_B_net;
	...
	cy_psoc3_pins_v1_10
		...
		LCD_B
		 (.oe(tmpOE__LCD_B_net),
		  .y({Net_383}),
		  .fb({tmpFB_0__LCD_B_net[0:0]}),
		  .io({tmpIO_0__LCD_B_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_B_net),
		  .interrupt({tmpINTERRUPT_0__LCD_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ENC_R_net;
	wire [0:0] tmpFB_0__ENC_R_net;
    ...
    CyControlReg_v1_80 ENC_Backlight (
        .control_1(Net_394),
        .control_2(Net_395),
        .control_3(Net_396),
        .control_0(Net_393),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam ENC_Backlight.Bit0Mode = 0;
    defparam ENC_Backlight.Bit1Mode = 0;
    defparam ENC_Backlight.Bit2Mode = 0;
    defparam ENC_Backlight.Bit3Mode = 0;
    defparam ENC_Backlight.Bit4Mode = 0;
    defparam ENC_Backlight.Bit5Mode = 0;
    defparam ENC_Backlight.Bit6Mode = 0;
    defparam ENC_Backlight.Bit7Mode = 0;
    defparam ENC_Backlight.BitValue = 0;
    defparam ENC_Backlight.BusDisplay = 0;
    defparam ENC_Backlight.ExtrReset = 0;
    defparam ENC_Backlight.NumOutputs = 3;

	wire [0:0] tmpOE__ENC_G_net;
	wire [0:0] tmpFB_0__ENC_G_net;
	wire [0:0] tmpIO_0__ENC_G_net;
	wire [0:0] tmpINTERRUPT_0__ENC_G_net;
	electrical [0:0] tmpSIOVREF__ENC_G_net;
	...
	cy_psoc3_pins_v1_10
		...
		ENC_G
		 (.oe(tmpOE__ENC_G_net),
		  .y({Net_394}),
		  .fb({tmpFB_0__ENC_G_net[0:0]}),
		  .io({tmpIO_0__ENC_G_net[0:0]}),
		  .siovref(tmpSIOVREF__ENC_G_net),
		  .interrupt({tmpINTERRUPT_0__ENC_G_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENC_G_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam PID_Timer.InterruptOnTC = 0;
    defparam PID_Timer.Resolution = 8;

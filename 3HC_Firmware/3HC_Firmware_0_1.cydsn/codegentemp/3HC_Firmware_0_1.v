...
module top ;
	...
	wire [0:0] tmpOE__X_CURR_IN_net;
	wire [0:0] tmpFB_0__X_CURR_IN_net;
	wire [0:0] tmpIO_0__X_CURR_IN_net;
	wire [0:0] tmpINTERRUPT_0__X_CURR_IN_net;
	electrical [0:0] tmpSIOVREF__X_CURR_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("bf1b78f3-bfe8-4580-8859-402378bfbeca"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		X_CURR_IN
		 (.oe(tmpOE__X_CURR_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__X_CURR_IN_net[0:0]}),
		  .analog({Net_322}),
		  .io({tmpIO_0__X_CURR_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__X_CURR_IN_net),
		  .interrupt({tmpINTERRUPT_0__X_CURR_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X_CURR_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

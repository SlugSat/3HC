...
uint8 I2C_IMU_initVar = 0u; /* Defines if component was initialized */

volatile uint8 I2C_IMU_state;  /* Current state of I2C FSM */


/*******************************************************************************
* Function Name: I2C_IMU_Init
********************************************************************************
*
* Summary:
...
void I2C_IMU_Init(void) 
{
    ...
    I2C_IMU_CFG_REG  = I2C_IMU_DEFAULT_CFG;
    I2C_IMU_XCFG_REG = I2C_IMU_DEFAULT_XCFG;
    I2C_IMU_ADDR_REG = I2C_IMU_DEFAULT_ADDR;
    I2C_IMU_CLKDIV1_REG = LO8(I2C_IMU_DEFAULT_DIVIDE_FACTOR);
    I2C_IMU_CLKDIV2_REG = HI8(I2C_IMU_DEFAULT_DIVIDE_FACTOR);
    ...
    I2C_IMU_CFG_REG      = I2C_IMU_DEFAULT_CFG;
    I2C_IMU_INT_MASK_REG = I2C_IMU_DEFAULT_INT_MASK;

    /* Enable interrupt generation in status */
    intState = CyEnterCriticalSection();
    I2C_IMU_INT_ENABLE_REG |= I2C_IMU_INTR_ENABLE;
    CyExitCriticalSection(intState);

    /* Configure bit counter */
    #if (I2C_IMU_MODE_SLAVE_ENABLED)
        I2C_IMU_PERIOD_REG = I2C_IMU_DEFAULT_PERIOD;
    #endif  /* (I2C_IMU_MODE_SLAVE_ENABLED) */

    /* Configure clock generator */
    #if (I2C_IMU_MODE_MASTER_ENABLED)
        I2C_IMU_MCLK_PRD_REG = I2C_IMU_DEFAULT_MCLK_PRD;
        I2C_IMU_MCLK_CMP_REG = I2C_IMU_DEFAULT_MCLK_CMP;
    ...
    CyIntDisable    (I2C_IMU_ISR_NUMBER);
    CyIntSetPriority(I2C_IMU_ISR_NUMBER, I2C_IMU_ISR_PRIORITY);
    #if (I2C_IMU_INTERN_I2C_INTR_HANDLER)
        (void) CyIntSetVector(I2C_IMU_ISR_NUMBER, &I2C_IMU_ISR);
    #endif /* (I2C_IMU_INTERN_I2C_INTR_HANDLER) */
    ...
    I2C_IMU_SlaveSetAddress(I2C_IMU_DEFAULT_ADDR);
#endif /* (I2C_IMU_MODE_SLAVE_ENABLED) */

#if (I2C_IMU_MODE_MASTER_ENABLED)
    /* Clear status and buffers index */
    I2C_IMU_mstrStatus = 0u;
...
void I2C_IMU_Enable(void) 
{
    ...
    intState = CyEnterCriticalSection();
    I2C_IMU_ACT_PWRMGR_REG  |= I2C_IMU_ACT_PWR_EN;
    I2C_IMU_STBY_PWRMGR_REG |= I2C_IMU_STBY_PWR_EN;
    CyExitCriticalSection(intState);
#else
    #if (I2C_IMU_MODE_SLAVE_ENABLED)
        /* Enable bit counter */
        uint8 intState = CyEnterCriticalSection();
        I2C_IMU_COUNTER_AUX_CTL_REG |= I2C_IMU_CNT7_ENABLE;
        CyExitCriticalSection(intState);
    #endif /* (I2C_IMU_MODE_SLAVE_ENABLED) */

    /* Enable slave or master bits */
    I2C_IMU_CFG_REG |= I2C_IMU_ENABLE_MS;
#endif /* (I2C_IMU_FF_IMPLEMENTED) */
...
*
* Global variables:
*  I2C_IMU_initVar - This variable is used to check the initial
...
{
    if (0u == I2C_IMU_initVar)
    {
        I2C_IMU_Init();
        I2C_IMU_initVar = 1u; /* Component initialized */
    }
...
void I2C_IMU_Stop(void) 
{
...
#if (I2C_IMU_TIMEOUT_ENABLED)
    I2C_IMU_TimeoutStop();
#endif  /* End (I2C_IMU_TIMEOUT_ENABLED) */
...
#if (I2C_IMU_FF_IMPLEMENTED)
    {
        ...
        blockResetCycles = ((uint16) ((uint16) I2C_IMU_CLKDIV2_REG << 8u) | I2C_IMU_CLKDIV1_REG) + 1u;

        /* Disable block */
        I2C_IMU_CFG_REG &= (uint8) ~I2C_IMU_CFG_EN_SLAVE;
        ...
        /* Enable block */
        I2C_IMU_CFG_REG |= (uint8) I2C_IMU_ENABLE_MS;
...
#if (I2C_IMU_MODE_SLAVE_ENABLED)
    {
        /* Disable bit counter */
        uint8 intState = CyEnterCriticalSection();
        I2C_IMU_COUNTER_AUX_CTL_REG &= (uint8) ~I2C_IMU_CNT7_ENABLE;
        CyExitCriticalSection(intState);
    }
#endif /* (I2C_IMU_MODE_SLAVE_ENABLED) */

    /* Clear interrupt source register */
    (void) I2C_IMU_CSR_REG;
#endif /* (I2C_IMU_FF_IMPLEMENTED) */
    ...
    /* Clear busy statuses */
#if (I2C_IMU_MODE_SLAVE_ENABLED)
    I2C_IMU_slStatus &= (uint8) ~(I2C_IMU_SSTAT_RD_BUSY | I2C_IMU_SSTAT_WR_BUSY);
#endif /* (I2C_IMU_MODE_SLAVE_ENABLED) */
}
